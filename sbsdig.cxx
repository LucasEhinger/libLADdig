...
//TODO: write a list of parameters that are not "frozen" (e.g. gain, pedestal parameters, etc...) and switch them into
databases... #define NPlanes_bbgem 32 // modules... #define NChan_bbps 52 #define NChan_bbsh 189 #define NChan_bbhodo
180 #define NChan_grinch 510 #define NChan_hcal 288
  ...
  */
      ...
      if (ntokens >= 2) {
        ...
        if (skey == "gain_bbps") {
          ...
          if (ntokens == NChan_bbps + 1) {
            ...
            cout << ntokens - 1 << " entries for " << skey << " dont match number of channels = " << NChan_bbps << endl
        ...
        if (skey == "gain_bbsh") {
          ...
          if (ntokens == NChan_bbsh + 1) {
            ...
            cout << ntokens - 1 << " entries for " << skey << " dont match number of channels = " << NChan_bbsh << endl
                 << " applying first value on all planes " << endl;
            TString stemp = ((TObjString *)(*tokens)[1])->GetString();
            for (int k = 0; k < NChan_bbsh; k++) {
              gain_bbsh[k] = stemp.Atof() * qe;
        ...
        if (skey == "gain_grinch") {
          ...
          if (ntokens == NChan_grinch + 1) {
            ...
            cout << ntokens - 1 << " entries for " << skey << " dont match number of channels = " << NChan_grinch
                 << endl
                 << " applying first value on all planes " << endl;
            TString stemp = ((TObjString *)(*tokens)[1])->GetString();
            for (int k = 0; k < NChan_grinch; k++) {
        ...
        if (skey == "gain_hcal") {
          ...
          if (ntokens == NChan_hcal + 1) {
            ...
            cout << ntokens - 1 << " entries for " << skey << " dont match number of channels = " << NChan_hcal << endl
                 << " applying first value on all planes " << endl;
            TString stemp = ((TObjString *)(*tokens)[1])->GetString();
            for (int k = 0; k < NChan_hcal; k++) {
              gain_hcal[k] = stemp.Atof() * qe;
        ...
        if (skey == "ft_layer_z") {
          ...
          if (ntokens == Nlayers_ft + 1) {
            ...
            cout << "number of entries for ft_layer_z = " << ntokens - 1 << " don't match nlayers = " << Nlayers_ft
                 << endl;
            cout << "fix your db " << endl;
          }
          nparam_ft_read++;
        ...
        if (skey == "layer_ft") {
          ...
          if (ntokens == NPlanes_ft + 1) {
            ...
            cout << "number of entries for layer_ft = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_ft
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
        ...
        if (skey == "nstrips_ft") {
          ...
          if (ntokens == NPlanes_ft + 1) {
            ...
            cout << "number of entries for nstrips_ft = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_ft
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
        ...
        if (skey == "offset_ft") {
          ...
          if (ntokens == NPlanes_ft + 1) {
            ...
            cout << "number of entries for offset_ft = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_ft
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
        ...
        if (skey == "RO_angle_ft") {
          ...
          if (ntokens == NPlanes_ft + 1) {
            ...
            cout << "number of entries for RO_angle_ft = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_ft
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
        ...
        if (skey == "gain_ft") {
          ...
          if (ntokens == NPlanes_ft / 2 + 1) {
            ...
            cout << "number of entries for gain_ft = " << ntokens - 1 << " don't match Nplanes/2 = " << NPlanes_ft / 2
                 << endl;
            if (ntokens >= 2) {
              cout << "applying first value on all planes " << endl;
              TString stemp = ((TObjString *)(*tokens)[1])->GetString();
        ...
        if (skey == "fpp1_layer_z") {
          ...
          if (ntokens == Nlayers_fpp1 + 1) {
            ...
            cout << "number of entries for fpp1_layer_z = " << ntokens - 1 << " don't match nlayers = " << Nlayers_fpp1
                 << endl;
            cout << "fix your db " << endl;
          }
          nparam_fpp1_read++;
        ...
        if (skey == "layer_fpp1") {
          ...
          if (ntokens == NPlanes_fpp1 + 1) {
            ...
            cout << "number of entries for layer_fpp1 = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_fpp1
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
        ...
        if (skey == "nstrips_fpp1") {
          ...
          if (ntokens == NPlanes_fpp1 + 1) {
            ...
            cout << "number of entries for nstrips_fpp1 = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_fpp1
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
        ...
        if (skey == "offset_fpp1") {
          ...
          if (ntokens == NPlanes_fpp1 + 1) {
            ...
            cout << "number of entries for offset_fpp1 = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_fpp1
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
        ...
        if (skey == "RO_angle_fpp1") {
          ...
          if (ntokens == NPlanes_fpp1 + 1) {
            ...
            cout << "number of entries for RO_angle_fpp1 = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_fpp1
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
        ...
        if (skey == "fpp2_layer_z") {
          ...
          if (ntokens == Nlayers_fpp2 + 1) {
            ...
            cout << "number of entries for fpp2_layer_z = " << ntokens - 1 << " don't match nlayers = " << Nlayers_fpp2
                 << endl;
            cout << "fix your db " << endl;
          }
          nparam_fpp2_read++;
        ...
        if (skey == "layer_fpp2") {
          ...
          if (ntokens == NPlanes_fpp2 + 1) {
            ...
            cout << "number of entries for layer_fpp2 = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_fpp2
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
        ...
        if (skey == "nstrips_fpp2") {
          ...
          if (ntokens == NPlanes_fpp2 + 1) {
            ...
            cout << "number of entries for nstrips_fpp2 = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_fpp2
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
        ...
        if (skey == "offset_fpp2") {
          ...
          if (ntokens == NPlanes_fpp2 + 1) {
            ...
            cout << "number of entries for offset_fpp2 = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_fpp2
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
        ...
        if (skey == "RO_angle_fpp2") {
          ...
          if (ntokens == NPlanes_fpp2 + 1) {
            ...
            cout << "number of entries for RO_angle_fpp2 = " << ntokens - 1 << " don't match Nplanes = " << NPlanes_fpp2
                 << endl;
            cout << "fix your db " << endl;
            exit(-1);
          }
  ...
  for (int k = 0; k < detectors_list.size(); k++) {
    ...
    if (detectors_list[k] == "cepol_front") {
      ...
      SBSDigGEMDet *cepol_front =
          new SBSDigGEMDet(CEPOL_GEMFRONT_UNIQUE_DETID, NPlanes_cepol_front, layer_cepol_front, nstrips_cepol_front,
                           offset_cepol_front, RO_angle_cepol_front, 6, ZsupThr_cepol_front);
      SBSDigGEMSimDig *gemdig =
          new SBSDigGEMSimDig(NPlanes_cepol_front / 2, triggeroffset_cepol_front, ZsupThr_cepol_front, nAPV_cepol_front,
                              commonmode_array_cepol_front);
    ...
    if (detectors_list[k] == "cepol_rear") {
      ...
      SBSDigGEMDet *cepol_rear =
          new SBSDigGEMDet(CEPOL_GEMREAR_UNIQUE_DETID, NPlanes_cepol_rear, layer_cepol_rear, nstrips_cepol_rear,
                           offset_cepol_rear, RO_angle_cepol_rear, 6, ZsupThr_cepol_rear);
      SBSDigGEMSimDig *gemdig = new SBSDigGEMSimDig(NPlanes_cepol_rear / 2, triggeroffset_cepol_rear,
                                                    ZsupThr_cepol_rear, nAPV_cepol_rear, commonmode_array_cepol_rear);
    ...
    if (detectors_list[k] == "prpolbs_gem") {
      ...
      SBSDigGEMDet *prpolbs_gem =
          new SBSDigGEMDet(PRPOLBS_GEM_UNIQUE_DETID, NPlanes_prpolbs_gem, layer_prpolbs_gem, nstrips_prpolbs_gem,
                           offset_prpolbs_gem, RO_angle_prpolbs_gem, 6, ZsupThr_prpolbs_gem);
      SBSDigGEMSimDig *gemdig =
          new SBSDigGEMSimDig(NPlanes_prpolbs_gem / 2, triggeroffset_prpolbs_gem, ZsupThr_prpolbs_gem, nAPV_prpolbs_gem,
                              commonmode_array_prpolbs_gem);
    ...
    if (detectors_list[k] == "prpolfs_gem") {
      ...
      SBSDigGEMDet *prpolfs_gem =
          new SBSDigGEMDet(PRPOLFS_GEM_UNIQUE_DETID, NPlanes_prpolfs_gem, layer_prpolfs_gem, nstrips_prpolfs_gem,
                           offset_prpolfs_gem, RO_angle_prpolfs_gem, 6, ZsupThr_prpolfs_gem);
      SBSDigGEMSimDig *gemdig =
          new SBSDigGEMSimDig(NPlanes_prpolfs_gem / 2, triggeroffset_prpolfs_gem, ZsupThr_prpolfs_gem, nAPV_prpolfs_gem,
                              commonmode_array_prpolfs_gem);
    ...
    if (detectors_list[k] == "ft") {
      ...
      SBSDigGEMDet *ft =
          new SBSDigGEMDet(FT_UNIQUE_DETID, NPlanes_ft, layer_ft, nstrips_ft, offset_ft, RO_angle_ft, 6, ZsupThr_ft);
      SBSDigGEMSimDig *gemdig =
          new SBSDigGEMSimDig(NPlanes_ft / 2, triggeroffset_ft, ZsupThr_ft, nAPV_ft, commonmode_array_ft);
    ...
    if (detectors_list[k] == "fpp1") {
      ...
      SBSDigGEMDet *fpp1 = new SBSDigGEMDet(FPP1_UNIQUE_DETID, NPlanes_fpp1, layer_fpp1, nstrips_fpp1, offset_fpp1,
                                            RO_angle_fpp1, 6, ZsupThr_fpp1);
      SBSDigGEMSimDig *gemdig =
          new SBSDigGEMSimDig(NPlanes_fpp1 / 2, triggeroffset_fpp1, ZsupThr_fpp1, nAPV_fpp1, commonmode_array_fpp1);
    ...
    if (detectors_list[k] == "fpp2") {
      ...
      SBSDigGEMDet *fpp2 = new SBSDigGEMDet(FPP2_UNIQUE_DETID, NPlanes_fpp2, layer_fpp2, nstrips_fpp2, offset_fpp2,
                                            RO_angle_fpp2, 6, ZsupThr_fpp2);
      SBSDigGEMSimDig *gemdig =
          new SBSDigGEMSimDig(NPlanes_fpp2 / 2, triggeroffset_fpp2, ZsupThr_fpp2, nAPV_fpp2, commonmode_array_fpp2);
    ...
    if (detectors_list[k] == "bbps") {
      ...
      // SBSDigPMTDet* bbps = new SBSDigPMTDet(BBPS_UNIQUE_DETID, NChan_bbps, gain_bbps*qe, sigmapulse_bbps,
      // gatewidth_bbps);
    ...
    if (detectors_list[k] == "bbsh") {
      ...
      // SBSDigPMTDet* bbsh = new SBSDigPMTDet(BBSH_UNIQUE_DETID, NChan_bbsh, gain_bbsh*qe, sigmapulse_bbsh,
      // gatewidth_bbsh);
    ...
    if (detectors_list[k] == "grinch") {
      ...
      SBSDigPMTDet *grinch =
          new SBSDigPMTDet(GRINCH_UNIQUE_DETID, NChan_grinch, gain_grinch, sigmapulse_grinch, gatewidth_grinch);
    ...
    if (detectors_list[k] == "prpolscint_bs") {
      ...
      SBSDigPMTDet *polscint_bs = new SBSDigPMTDet(PRPOLBS_SCINT_UNIQUE_DETID, NChan_polscint_bs, gain_polscint_bs,
                                                   sigmapulse_polscint_bs, gatewidth_polscint_bs);
    ...
    if (detectors_list[k] == "prpolscint_fs") {
      ...
      SBSDigPMTDet *polscint_fs = new SBSDigPMTDet(PRPOLFS_SCINT_UNIQUE_DETID, NChan_polscint_fs, gain_polscint_fs,
                                                   sigmapulse_polscint_fs, gatewidth_polscint_fs);
    ...
    if (detectors_list[k] == "activeana") {
      ...
      // sigmapulse_activeana, gatewidth_activeana);
